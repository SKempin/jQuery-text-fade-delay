...
(function($) {
    $.fn.fader = function(options) {
        ...
        function fade(toFade, testimonial, cite) {
            ...
            cite[toShow].stop(true, true).delay(settings.citeDelay).animate({
                opacity: 1
        ...
        var testimonial = [];
        $(this).find('li blockquote').each(function() {
        ...
        // find li, add to text array and hide them
        var cite = [];
        $(this).find('li cite').each(function() {
            cite.push($(this));
            $(this).css({
                opacity: 0
            });
        ...
        cite[0].stop(true, true).delay(settings.citeDelay / 2).animate({
            opacity: 1
        }, settings.fadeSpeed / 2);
